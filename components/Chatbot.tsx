...
export const Chatbot: React.FC = () => {
  ...
  // FIX: Explicitly typed MessageBubble as a React.FC to correctly handle the `key` prop.
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-170px)] bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl">
      ...
      <div className="p-6 border-t border-white/10">
        <form onSubmit={handleSendMessage} className="flex items-center gap-4">
          <input
            ...
            className="flex-grow bg-gray-900/50 border border-white/20 rounded-lg p-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition"
            disabled={isLoading}
          />
          <button
            type="submit"
